...
pander(pcs$rotation[,1:2] %*% diag(pcs$sdev[1:2]^2) %*% t(pcs$rotation[,1:2]),
       ...
       split.table = Inf)
```
```{r p3_b, echo=F, comment=NA, fig.pos="H", fig.align="center", cache=T, size="footnotesize"}
...
require(psych)
principalcs <- principal(cc2015Rs_2, scale=T, center=T)
