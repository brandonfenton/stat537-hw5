...
Then $\mathbf{A}'\mathbf{A}=\mathbf{I}$ implies that the $\mathbf{a}_j$ are orthogonal unit vectors.
...
library(pander)
```
```{r p1_b, echo=F, comment=NA, fig.pos="H", fig.align="center", cache=T, size="footnotesize"}
